...
### **1. Script.sql**  
Arquivo contendo todo o código SQL utilizado no exercício:
...
🔗 **Link para o Script:**  
[CLIQUE AQUI PARA ABRIR O Script.SQL](Script.sql)
...
🔗 **Link para o PDF:**  
[CLIQUE AQUI PARA ABRIR O Problema.PDF](Problema.pdf)
...
- Consultas utilizando:  
  ...
  - **GROUP BY**  
  - **COUNT()**  
- Relatórios aplicados a cenários reais (marketing, filtragem por estado, tipo de telefone etc.)
...
- Relatórios para campanhas de marketing com critérios específicos  
...
MySQL Workbench, XAMPP, WAMP ou qualquer SGBD compatível.
