...
/* ===========================================================
   1) Funcionários por departamento (FILMES ou ROUPAS)
   -----------------------------------------------------------
   Primeiro exibimos o total de funcionários por departamento
   para análise geral de distribuição.
   Em seguida, filtramos os funcionários que atuam nos setores
   FILMES ou ROUPAS, conforme solicitado no exercício.
   =========================================================== */

-- Contagem total por departamento
SELECT COUNT(*) AS TOTAL_FUNCIONARIOS, DEPARTAMENTO
FROM FUNCIONARIOS
GROUP BY DEPARTAMENTO
ORDER BY TOTAL_FUNCIONARIOS DESC;

-- Funcionários dos departamentos FILMES ou ROUPAS
...
/* ===========================================================
   2) Lista das funcionárias dos departamentos FILMES ou LAR
   -----------------------------------------------------------
   O gestor de marketing precisa enviar e-mails às funcionárias
   desses dois setores. Por isso, primeiro contamos quantas são,
   e depois listamos seus dados para comunicação.
   =========================================================== */

-- Contagem das funcionárias por departamento
SELECT COUNT(*) AS TOTAL_FUNCIONARIAS, DEPARTAMENTO
FROM FUNCIONARIOS
WHERE SEXO = 'FEMININO'
GROUP BY DEPARTAMENTO;

-- Dados das funcionárias dos setores FILMES ou LAR
SELECT NOME, DEPARTAMENTO, EMAIL, SEXO
FROM FUNCIONARIOS 
WHERE SEXO = 'FEMININO'
  AND DEPARTAMENTO IN ('FILMES', 'LAR');



/* ===========================================================
   3) Funcionários do sexo masculino OU do setor JARDIM
   -----------------------------------------------------------
   Funcionários masculinos devem ser exibidos independentemente
   do departamento. Além disso, todos os funcionários que
   trabalham no setor JARDIM também devem aparecer, mesmo que 
